                ...
                <div class="flex mt-3 gap-2">
                    ...
                    <div class="flex flex-col flex-1 min-w-0">
                        <div class="flex justify-between items-start">
                            ...
                            <div class="h-8 w-8 aspect-square rounded-full flex items-center justify-center hover:bg-red-500 transition cursor-pointer -shrink-0 opacity-0 group-hover:opacity-100">
