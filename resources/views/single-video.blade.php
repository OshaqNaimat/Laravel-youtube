...
<head>
    ...
    <title>ReduxTube - Watch Video with Description</title>
    <!-- TailwindCSS v3 + Font Awesome Icons + Google Fonts -->
...
<body>
    <div id="app">
        <!-- Header (fixed, red/black YouTube style) -->
        <header
            class="top-header bg-yt-dark border-b border-red-900/40 shadow-md px-4 md:px-6 py-3 flex items-center justify-between">
            <div class="flex items-center gap-2">
                <i class="fab fa-youtube text-yt-red text-2xl"></i>
                <span class="font-bold text-xl tracking-tight text-white">Redux<span
                        class="text-yt-red">Tube</span></span>
            </div>
            <div class="flex items-center gap-4">
                <i class="fas fa-search text-yt-gray hover:text-white cursor-pointer transition"></i>
                <i class="fas fa-bell text-yt-gray hover:text-white cursor-pointer transition"></i>
                <div
                    class="w-8 h-8 rounded-full bg-yt-red flex items-center justify-center text-white text-sm font-bold">
                    U</div>
            </div>
        </header>
                ...
                <div class="flex flex-col lg:flex-row gap-6">
                    ...
                    <div class="lg:w-2/3 w-full">
                        ...
                        <div class="mt-4 border-b border-gray-800 pb-3">
                            <h1 id="videoTitle" class="text-white text-xl md:text-2xl font-semibold leading-tight">Epic
